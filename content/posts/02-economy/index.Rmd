...
`r round(cor.coef, 2) ` and (p-value: `r format(cor.test.results$p.value, scientific = TRUE, digits = 2)`)


`r round(cor.coef.2, 2) `  (p-value: `r format(cor.test.results.2$p.value, scientific = TRUE, digits = 2)`)
