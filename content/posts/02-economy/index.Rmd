...
stargazer(model1, model2, model3, model4, model5, model6,
  ...
  as_image(file = "static/02-economy/table1.png")
```

```{r table 1, echo = FALSE, fig.align='center', out.width='100%', fig.cap='Models of Economic Voting Based on 1948-2020 Data'}
knitr::include_graphics("static/02-economy/table1.png")
```
...
![Scenario 1: Across columns](/02-economy/table1.png)
